...
while True: #si mensaje en exit, salir
    ...
    Escenario_complejo = (f"Eres un diseñador de escenarios. Toma el siguiente escenario simple {Escenario} y expándelo en una descripción detallada de TRES párrafos. El primer párafo debe describir la atmósfera y el estado general del personaje {Character}. El segundo párrafo debe listar 5-7 objetos específicos (con color, ubicación, y matiz emocional), que puedan ser interactivos. El tercer párrafp debe establecer el sonido, el olor y la hora del día")
