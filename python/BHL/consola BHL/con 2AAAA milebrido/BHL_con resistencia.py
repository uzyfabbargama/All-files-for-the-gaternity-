...
def Numeraso2_update():
    ...
    while caso != 3:
        ...
        caso = C4 + C5 + C6
        Numero_generado += D4 * (base/(expS+1)) % base + D5 * (base/(expHu+1))%base + D6 * (base/(expC+1))%base #Esto conserva la energía emocional, ya que si tiene experiencia 1, su valor va a quedare en 50, en lugar de 0
...
if cargando_partida:
    ...
    def cargar_valores():
        ...
        baño, hambre, sueño = Numero//PosX, Numero//PosY, Numero//PosZ
        return
else:    
    #Datos de entrada
