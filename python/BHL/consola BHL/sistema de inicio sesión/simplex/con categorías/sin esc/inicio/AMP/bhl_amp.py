...
base = 1000
#test = [1234, "Solo sabe decir sí o no", 20, 20, 20, 20, 20, 20, "AIzaSyBa6T3dKbfNA_SxI_dj5Ymk7fB6gk8i3zM", "hola"]
...
PosC = base #2**10
PosZ = 1
Archivo = str(inputs("Elija el nombre de la conversación: ", test[0]))
