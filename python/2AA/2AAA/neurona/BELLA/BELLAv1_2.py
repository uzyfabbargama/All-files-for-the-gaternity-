# =======================================================
# BELLA v1.1: MOTOR DE PERSONALIDAD (4096 NEURONAS)feb. 22, 2026, 02:33:19
# =======================================================
...
def entrenar_con_presion(texto, neurona_fija=None):
    for i in range(0, len(texto), 8):
        frag = texto[i:i+8]
        # Si le pasamos una neurona_fija, concentramos TODA la fuerza ahí
        idx = neurona_fija if neurona_fija is not None else (xorid(frag) % num_n)
        
        # ROMPEMOS EL EQUILIBRIO: Le sumamos el ID directamente a la memoria
        # antes de entrar al update para que el 'while caso != 3' TENGA que trabajar.
...
if __name__ == "__main__":
    ...
    # Inyectamos fuerza
    # Forzamos a que todo el 'amor' golpee a la Neurona 100
    entrenar_con_presion(discurso_positivo, neurona_fija=100)
    # Forzamos a que todo el 'odio' golpee a la Neurona 200
    entrenar_con_presion(discurso_negativo, neurona_fija=200)
