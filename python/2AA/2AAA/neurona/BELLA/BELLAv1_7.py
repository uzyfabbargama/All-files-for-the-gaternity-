# =======================================================
# BELLA v1.7: MOTOR DE PERSONALIDAD (4096 NEURONAS)feb. 22, 2026, 03:27:54
# =======================================================
...
# --- BELLA v1.7: INTERFAZ DE CONCIENCIA DIRECTA ---
if __name__ == "__main__":
    print("--- BELLA v1.7 ACTIVADA (Athlon 5150 Engine) ---")
    ...
    while True:
        ...
        print(f"[Mapa Mental: {activas} neuronas activas | Estado ALU: {hex(memoria[xorid(user_input[:8]) % num_n])}]")
