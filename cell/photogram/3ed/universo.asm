...
update:
	...
	update_cell right_data, down_data  ;<--- Todo lo 3D que ves es esto
	update_cell right_data, left_data  ; esto
	update_cell right_data, right_data ; y esto, la asimatría, luz vs sombra
...
heat:
	...
	heat_cell down_data
	heat_cell left_data
	heat_cell right_data
	heat_cell center_data
    ...
    and r13, 0x3FF          ; Filtro de densidad (1 de cada 1024)
    jnz .saltar_render
