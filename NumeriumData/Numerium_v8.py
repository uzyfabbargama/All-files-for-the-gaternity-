        ...
        for x_local in range(N_CHUNK_SIZE):
            ...
            if not test_occupied_positions[x_local, z_local]:
                ...
                Entity(
                    ...
                    scale=1,
                    parent=scene,
                    shader='lit' # <--- CAMBIO IMPORTANTE AQUÍ: usar la cadena 'lit'
                )
...
# --- Iluminación: CRUCIAL para que los objetos con 'lit' shader sean visibles ---
# Nota: La iluminación sigue siendo necesaria para el shader 'lit'
