...
package net.mcreator.gnulmod.keybind;
...
import net.mcreator.gnulmod.procedure.ProcedureGuidetailsOnKeyPressed;
import net.mcreator.gnulmod.Gnulmod;
import net.mcreator.gnulmod.ElementsGnulmod;

@ElementsGnulmod.ModElement.Tag
public class KeyBindingGuidetails extends ElementsGnulmod.ModElement {
	private KeyBinding keys;
	public KeyBindingGuidetails(ElementsGnulmod instance) {
		super(instance, 10);
	}
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				Gnulmod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureGuidetailsOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
