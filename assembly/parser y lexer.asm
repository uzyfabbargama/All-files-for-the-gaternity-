...
;Parser[0]
    ;nif[0]
        ...
        cmovz r11, 1
            ;do
            add r8, r11 ;CTRL[0] {1, nif[0]((VAR[0]) += 1}
        ;if["CTRL"]
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        cmovz r11, 0x10 
            ;do
            add r8, r11 ;CTRL[1] {1, nif[0]((VAR[1]) += 1}
        ;if["CLASS"]
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        cmovz r11, 0x100
            ;do
            add r8, r11 ;CTRL[2] {1, nif[0]((VAR[2]) += 1}
        ;if("(")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        cmovz r11, 0x1000
            ;do
            add r8, r11 ;CTRL[3] {1, nif[0]((VAR[3]) += 1}
        ;if(",")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        cmovz r11, 0x10000
            ;do
            add r8, r11 ;CTRL[4] {1, nif[0]((VAR[4]) += 1}
        ;if(")")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        cmovz r11, 0x1000000
            ;do
            add r8, r11 ;CTRL[6] {1, nif[0]((VAR[6]) += 1}
        ;if("}")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        or rdx, r9      ;colocar el byte
        cmp rdx, INPUT  ;} detect
        cmovz r11, 0x10000000
            ;do
            add r8, r11 ;CTRL[7] {1, nif[0]((VAR[7]) += 1}
        ;if("+")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        or rdx, r9      ;colocar el byte
        cmp rdx, INPUT  ;+ detect
        cmovz r11, 0x100000000
            ;do
            add r8, r11 ;CTRL[8] {1, nif[0]((VAR[8]) += 1}
        ;if("-")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        or rdx, r9      ;colocar el byte
        cmp rdx, INPUT  ;- detect
        cmovz r11, 0x1000000000
            ;do
            add r8, r11 ;CTRL[9] {1, nif[0]((VAR[9]) += 1}
        ;if("*")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        or rdx, r9      ;colocar el byte
        cmp rdx, INPUT  ;* detect
        cmovz r11, 0x10000000000
            ;do
            add r8, r11 ;CTRL[10] {1, nif[0]((VAR[10]) += 1}
        ;if("/")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        or rdx, r9      ;colocar el byte
        cmp rdx, INPUT  ;/ detect
        cmovz r11, 0x100000000000
            ;do
            add r8, r11 ;CTRL[11] {1, nif[0]((VAR[11]) += 1}
        ;if("**")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        cmp rdx, INPUT  ;** detect
        cmovz r11, 
        cmovz r11, 0x1000000000000
            ;do
            add r8, r11 ;CTRL[12] {1, nif[0]((VAR[12]) += 1}
        ;if(";")
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        or rdx, r9      ;colocar el byte
        cmp rdx, INPUT  ;; detect
        cmovz r11, 0x100000000000000
            ;do
            add r8, r11 ;CTRL[14] {1, nif[0]((VAR[14]) += 1}
        ;if('"')
        mov rdx, 0      ;Para guardar
        mov r11, 0      ;Para comparar
        mov r9, INPUT   ;Operador
        ...
        or rdx, r9      ;colocar el byte
        cmp rdx, INPUT  ;( detect
        cmovz r11, 0x1000000000000000
            ;do
            add r8, r11 ;CTRL[15] {1, nif[0]((VAR[15]) += 1}
;);
