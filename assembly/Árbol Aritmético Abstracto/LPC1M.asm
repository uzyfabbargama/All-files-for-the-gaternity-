...
;Parser[0]
    ...
    %endmacro
    %macro save 0
    if r14, " ";detecta espacio
    do_in r14 ;si hubo espacio anteriormente, guardar
    mov r14, r11
    %endmacro
	%macro BigToken %3
	super_if%1 %2, %3 ;%1 tamaño del bigtoken (de 2 a 8), %2 pos
	;do
	do_in r15
	%endmacro
    ;byte identifier
        ...
        super_if3 ("VAR", P_VAR)
            ...
            sumar_indice ;suma a rsi, para detectar el próximo token, si era correcto
