...
;Parser[0]
    ...
    ;Check 'V'
        or r9b, INPUT[i]	    ;Cargar 'V'
        shl r9, 8           ;Preparar para "A"
    ;Check 'A'
        or r9b, INPUT[i+1]   ;Cargar 'A'
        shl r9, 8           ;Preparar para "R"
    ;Check 'R'
        or r9b, INPUT[i+2]   ;Cargar 'R'
    ...
    %macro super_if4 (2)
            ...
            mov r10, 0	        ;Registro de Fallo
            ;Check 'C'
            mov r9b, INPUT[i] 	; Cargar 'C'
            shl r9, 8           ;Preparar para "T"
            ;Check 'T'
            mov r9b, INPUT[i+1]	; Cargar 'T'
            shl r9, 8           ;Preparar para "R"
            ; Check 'R'
            mov r9b, INPUT[i+2]	; Cargar 'R'
            shl r9, 8           ;Preparar para "L"
            ; Check 'L'
            mov r9b, INPUT[i+3]	; Cargar 'L'
