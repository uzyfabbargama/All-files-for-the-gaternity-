...
;Definir CLASS
    ...
    %define P_CLASS 0x10
;Definir (
    %define KW_PARENTESIS_OPEN 6
    %define P_PARENTESIS_OPEN 0X40
;Definir ,
    %define KW_COMMA 8
    %define P_COMMA 0X100
;Definir )
    %define KW_PARENTESIS_CLOSE 10
    %define P_PARENTESIS_CLOSE 0X400
;Definir {
    %define KW_LLAVES_OPEN 12
    %define P_LLAVES_OPEN 0X1_000
;Definir }
    %define KW_LLAVES_CLOSE 14
    %define P_LLAVES_CLOSE 0X4_000
;Definir +
    %define KW_ADD 16
    %define P_ADD 0X10_000
;Definir -
    %define KW_SUB 18
    %define P_SUB 0X40_000
;Definir *
    %define KW_MUL 20
    %define P_MUL 0X100_000
;Definir /
    %define KW_DIV 22
    %define P_DIV 0X400_000
;Definir **
    %define KW_POWER 24
    %define P_POWER 0X1_000_000
;Definir ;
    %define KW_SEMICOLON 26
    %define P_SEMICOLON 0X4_000_000
;Definir =
    %define KW_EQUAL 28
    %define P_EQUAL 0X10_000_000
;Definir "
    %define KW_COMILLAS 30
    %define P_COMILLAS 0X40_000_000
;Definir [
    %define KW_CORCHETE_OPEN 32
    %define P_CORCHETE_OPEN 0X100_000_000
;Definir ]
    %define KW_CORCHETE_CLOSE 34
    %define P_CORCHETE_CLOSE 0X400_000_000
;Definir .
    %define KW_PUNTO 36
    %define P_PUNTO 0X1_000_000_000
;Definir '
    %define KW_COMILLA 38
    %define P_COMILLA 0X4_000_000_000
;Definir #
    %define KW_COMMENT 40
    %define P_COMMENT 0X10_000_000_000
;Definir :
    %define KW_DIC 42
    %define P_DIC 0X40_000_000_000
;Definir !
    %define KW_NOT 44
    %define P_NOT 0X100_000_000_000
;Definir <
    %define KW_MENOR 46
    %define P_MENOR 0X400_000_000_000
;Definir >
    %define KW_MAYOR 48
    %define P_MAYOR 0X1_000_000_000_000
;Definir " "
    %define KW_SPACE 50
    %define P_SPACE 0X4_000_000_000_000
;Definir e
    %define KW_ERROR 52
    %define P_ERROR 0X10_000_000_000_000
;Definir \n (10 EN ASCII)
    %define KW_NEW_LINE 54 
    %define P_NEW_LINE 0X40_000_000_000_000
;Definir ^
    %define KW_XOR 56
    %define P_XOR 0X100_000_000_000_000
;Definir &
    %define KW_AND 58
    %define P_AND 0X400_000_000_000_000
;Definir |
    %define KW_OR 60 
    %define P_OR 0X1_000_000_000_000_000
...
%.macro CREATE_CTRL0()
    ...
    add cl, CTRLbits    ;añadido 2bits al lector
    shl r9, cl          ;desplazar r9 lo que nos marca el lector
    add r9, CTRL0       ;añadido VAR(1) (01)
