...
;registros permanentes
    ...
    ;r14 PG libre
    ;r15 PG #contexto keywords 1-40 (total 61 bits)
...
%endmacro        
%macro suma_cond 1
    mov r10, r9         ; Copiamos el éxito (0 o 1) a r10
    neg r10             ; r10 = 0 o FFFFFFFFFFFFFFFF
    and r10, %1         ; r10 = 0 o VALOR
    add r12, r10        ; ¡Inyección segura! r9 sigue vivo para el siguiente if
%endmacro
;num_checker
            if_num "1", Num_1
            sumar_indice
