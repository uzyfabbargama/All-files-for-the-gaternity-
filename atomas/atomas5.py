...
def mostrar_propiedades(atom):
  ...
  # Formato CSV: número,nombre,capas,I,O,longitud,pf,desapareados,mag,cond,react
    return f"{atom['numero']},{estado},{capas},{I},{O},{8-capas},{punto_fusion(atom):.1f},{electrones_desapareados(atom)},{fuerza_magnetica(atom):.2f},{'Si' if es_magnetico(atom) else 'No'},{conductividad(atom):.1f},{reactividad(atom):.1f}"
...
if __name__ == "__main__":
    ...
    # Cabecera CSV
    print("\n" + "="*120)
    print("N°,Nombre,Capas,I,O,Longitud,P.Fusion,Desap,Mag,Fuerza,Conduct,React")
    print("-"*120)
    
    # Mostrar todos los átomos en formato CSV
    for atom in atomos:
