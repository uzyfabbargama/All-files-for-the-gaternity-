...
while running:
    ...
    if current_screen == SCREEN_NETWORK:
        ...
        texto_eliminar = fuente.render("Borrar", True, NEGRO)
        ...
        simbolo = {"bidireccional": "Bidireccional", "salida": "->", "entrada": "<-"}[modo_conexion_tipo]
        ...
        texto_renombrar = fuente.render("Renombrar", True, NEGRO)
        ...
        texto_desconectar = fuente.render("Desconectar", True, NEGRO)
        ...
        texto_guardar = fuente.render("Guardar", True, NEGRO)
        ...
        texto_cargar = fuente.render("Cargar", True, NEGRO)
