...
while running:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 1: 
                    ...
                    if plus_button_rect.collidepoint(event.pos):
                        ...
                        modo_eliminar_activo = False
                        activation_mode_active = False
                        modo_renombrar_activo = False # Desactivar modo renombrar al cambiar de pantalla
                        rename_input_active = False
                        selected_neuron_for_rename_visual = None
    ...
    if current_screen == SCREEN_NETWORK:
        ...
        rename_button_rect = pygame.Rect(ANCHO_PANTALLA - 260, button_y, button_width, button_height) # Nuevo botón
        activate_nodes_button_rect = pygame.Rect(ANCHO_PANTALLA - 310, button_y, 100, button_height) # Ajustar posición
        save_button_rect = pygame.Rect(ANCHO_PANTALLA - 370, button_y, button_width, button_height) # Ajustar posición
        load_button_rect = pygame.Rect(ANCHO_PANTALLA - 430, button_y, button_width, button_height) # Ajustar posición
