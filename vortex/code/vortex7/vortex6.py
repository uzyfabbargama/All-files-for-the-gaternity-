...
class Vortex6(Vortex5):
    def __init__(self, *args, **kwargs):
        # Extraer fractal_level y max_fractal_level de kwargs
        self.fractal_level = kwargs.pop('fractal_level', 0)
        self.max_fractal_level = kwargs.pop('max_fractal_level', 3)
        
        # Llamar al __init__ de Vortex5 SOLO con los argumentos que espera
