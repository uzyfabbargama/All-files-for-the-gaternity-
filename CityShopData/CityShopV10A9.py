...
class Game:
    def __init__(self):
        ...
        self.initialize_game_values() # Esto inicializará la cuadrícula y los valores de color
        self.fill_grid() # Asegura que la cuadrícula se llene al inicio
        ...
        # Los botones de navegación de cuadrícula y compra de cuadrícula se eliminan al volver a V7
        # self.left_arrow_button = Button(...)
        # self.right_arrow_button = Button(...)
        # self.buy_grid_button = Button(...)
    ...
    def run(self):
        ...
        while running:
            for event in pygame.event.get():
                ...
                # Los botones de navegación y compra se eliminan al volver a V7
            ...
            if self.game_state == MENU:
                ...
                tutorial_text = [
                    ...
                    # Las siguientes líneas se eliminan al volver a V7
