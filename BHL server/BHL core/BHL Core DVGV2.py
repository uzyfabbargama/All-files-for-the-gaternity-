...
def bhl_sins_algorithm():
    ...
    soberbia, envidia, indiferencia y egoísmo. Este sistema utiliza la lógica de
    80+B para el NUMERASO para permitir el "acarreo" aritmético entre variables.
    """
    person = 0
    error = False
    ...
    # Lógica inicial de NUMERASO, ahora con la lógica (80+B)
    ...
    if per == "BHL":
        # CAMBIO: Se usa 80 + b en lugar de 100 - b
        numeraso = (80 + b) * 10**(new_pos - new_esp * 0) + (80 + h) * 10**(new_pos - new_esp * 1) + (80 + l) * 10**(new_pos - new_esp * 2) + (80 + s) * 10**(new_pos - new_esp * 3) + (80 + e) * 10**(new_pos - new_esp * 4) + (80 + i) * 10**(new_pos - new_esp * 5) + (80 + ego) * 10**(new_pos - new_esp * 6)
    else:
        numeraso = (80 + b) * 10**(new_pos - new_esp * 0) + (80 + h) * 10**(new_pos - new_esp * 1) + (80 + l) * 10**(new_pos - new_esp * 2) + (80 + s) * 10**(new_pos - new_esp * 3) + (80 + e) * 10**(new_pos - new_esp * 4) + (80 + i) * 10**(new_pos - new_esp * 5) + (80 + ego) * 10**(new_pos - new_esp * 6)
    ...
    while True:
        ...
        # Lógica de actualización de NUMERASO, ahora con la lógica (80+B)
        numeraso = (80 + b) * 10**(new_pos - new_esp * 0) + (80 + h) * 10**(new_pos - new_esp * 1) + (80 + l) * 10**(new_pos - new_esp * 2) + (80 + s) * 10**(new_pos - new_esp * 3) + (80 + e) * 10**(new_pos - new_esp * 4) + (80 + i) * 10**(new_pos - new_esp * 5) + (80 + ego) * 10**(new_pos - new_esp * 6)
        ...
        # CAMBIO: Se ajusta la lógica de decodificación a nb - 80
        b = nb - 80
        h = nh - 80
        l = nl - 80
        s = ns - 80
